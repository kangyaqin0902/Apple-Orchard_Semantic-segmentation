...
import rasterio  # ✅ 新增：读取GeoTIFF核心库，保留坐标系
from rasterio.transform import Affine  # ✅ 新增：读取仿射矩阵

# 图片格式支持列表 - 包含所有tif/tiff格式
IMG_EXTENSIONS = [
    '.jpg', '.JPG', '.jpeg', '.JPEG',
    '.png', '.PNG',
    '.tif', '.TIF', '.tiff', '.TIFF',
...
def __transforms2pil_resize(method):
    mapper = {
        ...
        transforms.InterpolationMode.LANCZOS: 1,
    }
